...
public:
	QueryResult(std::string& word,
		...
		std::shared_ptr<std::map<std::string, std::shared_ptr<std::set<int>>>> map_str_set_ptr,
...
private:
	...
	std::shared_ptr<std::map<std::string, std::shared_ptr<std::set<int>>>> map_str_set_ptr_;
